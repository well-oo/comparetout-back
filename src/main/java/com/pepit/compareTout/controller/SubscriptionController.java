...
public class SubscriptionController {
    ...
    @GetMapping
    public ResponseEntity<Collection<Subscription>> findAll() {
    ...
    public ResponseEntity<Subscription> findById(@PathVariable Long id) {
        try {
            Subscription object = service.findById(id);
    ...
    @PostMapping
    public ResponseEntity create(@Valid @RequestBody Subscription object) {
        try {
